...
var whatsAppLink="https://api.whatsapp.com/send?phone=+919680193899&text=Order%20details*";
...
function whatsapp(){
    ...
    whatsAppLink+="%0A" + "Total%20Price:%20"+ totalDollars + "%20" + totalCents+ "c"
}
cart.onclick =()=>{
    totalPrice();
    whatsapp();
    ...
    for(i=0;i<items.length;i++){
        if(item[i].quantity !=0);{
            console.log("items name:" + items[i].name + " - quantity: " + items[i].quantity);
        }
    }
